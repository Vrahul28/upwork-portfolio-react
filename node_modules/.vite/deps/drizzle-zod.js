  ...
  "~validate"(data) {
    ...
    if (!this["~standard"].async) {
      try {
        ...
        if ((_b = (_a4 = err == null ? void 0 : err.message) == null ? void 0 : _a4.toLowerCase()) == null ? void 0 : _b.includes("encountered")) {
  ...
  strict(message) {
    ...
    return new _ZodObject({
      ...
      ...message !== void 0 ? {
        errorMap: (issue, ctx) => {
          var _a4, _b;
          const defaultError = ((_b = (_a4 = this._def).errorMap) == null ? void 0 : _b.call(_a4, issue, ctx).message) ?? ctx.defaultError;
...
function numberColumnToSchema(column, z, coerce2) {
  ...
  let schema = coerce2 === true || (coerce2 == null ? void 0 : coerce2.number) ? z.coerce.number() : z.number();
...
function bigintColumnToSchema(column, z, coerce2) {
  ...
  const schema = coerce2 === true || (coerce2 == null ? void 0 : coerce2.bigint) ? z.coerce.bigint() : z.bigint();
...
function stringColumnToSchema(column, z, coerce2) {
  ...
  let schema = coerce2 === true || (coerce2 == null ? void 0 : coerce2.string) ? z.coerce.string() : z.string();
